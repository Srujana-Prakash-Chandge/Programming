///     Accept N Numbers from User and Display all such elements Divisible by 5 & 3
...
void Display(int Arr[], int iLength)
{
    ...
    {
        if((Arr[iCnt] % 3 == 0) && (Arr[iCnt] % 5 == 0)) // Check whether the element is divisible by both 3 and 5
        {
...
int main()
{
    ...
    Display(p, iSize);                          // Display elements divisible by both 3 and 5
