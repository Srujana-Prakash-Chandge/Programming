...
int main()
{
    ...
    iRet = FirstOcc(p, iSize, iValue);        // Pass the address of the array & its size & the Number No to the FirstOcc function and store the returned difference in iRet
    ...
    {
        printf("First Occurrence of the Number is %d", iRet); // Display index of first occurrence
    }
